            ...
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
                <table bgcolor="#1b5445" border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      <td class="Title" width="100%"><img src="../images/ico_contactus.gif" align="absmiddle"> Contact us</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div style="padding: 5px;">
                  <div class="notes">
                    <ul>
                      <li><a href="http://www.ahsay.com" target="_blank" class="stepLink">Our  Website</a></li>
                      <li><a href="http://forum.ahsay.com" target="_blank" class="stepLink">Discussion Forums</a></li>
                      <%-- to remove the link to the sales enquiries --%>
                      <%--
                      <li><a href="http://kb.ahsay.com/?_m=tickets&amp;_a=submit&amp;departmentid=4&amp;step=1" target="_blank" class="stepLink">Sales Enquiries</a></li>
                      --%>
                    </ul>
                  </div>
                </div>
