            ...
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
                ...
                <div style="padding: 5px;">
                  <div class="notes">
                    <ul>
                      <li>Support near real-time replication of data to <script language="JavaScript">document.write(RPSName_Short);</script></li> 
                      <li>Add off-site protection to backup data on <script language="JavaScript">document.write(OBSName_Short);</script> 
                        easily</li> 
                      <li>Fully automatic. No human invention required.</li>
                      <li>Flexible bandwidth throttling of replication traffic</li>
                      <li>Secure transfer of replication data through internet 
                        using SSL channels</li>
                      <li>Completely free of charge when used with <script language="JavaScript">document.write(OBSName_Short);</script></li>
                    </ul>
                  </div>
                </div>
              </td>
