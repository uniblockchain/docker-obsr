            ...
            <tr>
              <td rowspan="2" class="lNavigation" bordercolor="#F9F9F9" width="100%">
                ...
                <div style="padding: 5px;">
                  <div class="notes">
                    <ul>
                      <li><a href="/rps/doc/rps-admin-guide_en.pdf" target="_blank"> Administrator's Guide</a> - How to setup and configure 
                        <script language="JavaScript">document.write(RPSName_Short);</script> </li> 
                    </ul>
                  </div>
                </div>
              </td>
