    ...
    <tr height="99%">
      <td valign="top">
       ...
       <table cellpadding="0" cellspacing="0" height="10" width="100%">
        ...
        <table cellpadding="0" cellspacing="0" height="10" width="300">
          <tbody>
            <tr>
              <td></td>
            </tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
              <div class="Title"><strong><img src="../images/ico_RPS.gif" alt="RPS" align="absmiddle"></strong> <a href="nav_a1.jsp" class="TitleLink">Getting Started with <script language="JavaScript">document.write(RPSName_Short);</script></a></div> 
		      </td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr>            
              <td rowspan="2" class="lNavigation" bordercolor="#F9F9F9" valign="top" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step On" bgcolor="#92e1cf" width="99%">Setup <script language="JavaScript">document.write(RPSName_Short);</script></td> 
                    </tr>
                  </tbody>
                </table>
				...
				<li><script language="JavaScript">document.write(OBSName_Short);</script> IP: <b>10.0.0.1</b> Port: <b>80</b></li>
				<li><script language="JavaScript">document.write(RPSName_Short);</script> IP: <b>10.0.0.2</b> Port: <b>80</b></li>
				<li>Replication Receiver IP: <b>10.0.0.2</b> Port: <b>9444</b></li>
				<li>No Firewall between <script language="JavaScript">document.write(OBSName_Short);</script> and <script language="JavaScript">document.write(RPSName_Short);</script>.</li>
				</ul>				</div>


                  <ol style="list-style-type: lower-roman;">
                  <li style="padding-bottom: 5px;">Go to the [<script language="JavaScript">document.write(RPSName_Short);</script> Administration Console] page and logon with the following information: e.g. <br>http://10.0.0.2/rps/system/logon.do?locale=en
				  <br> &nbsp;- Login Name: <span style="font-weight: bold;" class="style1">system </span>(default)<br> &nbsp;- Password: <span style="font-weight: bold;" class="style1">system</span> (default)</li>
                  </li>
                  <li style="padding-bottom: 5px;">Create a new replication receiver on <script language="JavaScript">document.write(RPSName_Short);</script> -> [Manage Receiver] -&gt; [Add]. 				  
				  </li>
                  </ol>
                </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step" bgcolor="#92e1cf" width="99%"><a href="nav_a2.jsp" class="stepLink">Setup  
                        <script language="JavaScript">document.write(OBSName_Short);</script></a></td>
                    </tr>
                  </tbody>
                </table>
