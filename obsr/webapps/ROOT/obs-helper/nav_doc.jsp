      ...
      <td valign="top">
       ...
       <table cellpadding="0" cellspacing="0" height="10" width="100%">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <td rowspan="2" class="lNavigation" bordercolor="#F9F9F9" width="100%">
                <table bgcolor="#095798" border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      <td class="Title" width="100%"><img src="../images/ico_doc.gif" align="absmiddle"> Documentation</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div style="padding: 5px;">
                  <div class="notes">
                    <ul>
                      <%-- <li><a href="/obs/doc/obs-faq.pdf" target="_blank">FAQ</a> - Common questions and answers </li> --%>
                      <li><a href="/obs/doc/obs-admin-guide.pdf" target="_blank"> Administrator's Guide</a> - How to setup and configure <script language="JavaScript">document.write(OBSName_Short);</script> </li>
                      <li><a href="/obs/doc/obs-user-guide.pdf" target="_blank">User's Guide</a> - How to setup and use <script language="JavaScript">document.write(OBMName_Short);</script></li>
                      <li><a href="/obs/doc/infile-delta-whitepaper.pdf" target="_blank">In-file delta Guide</a> - How incremental and differential In-file delta works</li>
                    </ul>
                  </div>
                </div>
              </td>
