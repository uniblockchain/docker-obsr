            ...
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
                ...
                <div style="padding: 5px;">
                  <div class="step"><a href="nav_sm1.jsp" class="stepLink">  <script language="JavaScript">document.write(OBSName_Short);</script> Management Console</a></div>
                  <div style="padding-bottom: 5px;"><img src="../images/spacer.gif" height="1"></div>
                  <div class="step"><a href="nav_sm2.jsp" class="stepLink">  <script language="JavaScript">document.write(OBMName_Short);</script> (Client software) download / install</a></div>
                  <div style="padding-bottom: 5px;"><img src="../images/spacer.gif" height="1"></div>
                  <div class="step On"><span class="notes">  <script language="JavaScript">document.write(OBSName_Short);</script> User Console</span></div>
                  <div class="notes">
                    <ul>
                      <li>This is a web interface for users to access their backup files and settings.</li>
                    </ul>
                    <div style="padding-top: 5px;">Please choose your language to start with:
                      <form name="form" style="padding-top: 3px;">
                        ...
                        <input name="BUTTON" style="height: 19px; font-size: 11px;" onClick="leaptouser(this.form)" value="Go" type="button">
                      </form>
                    </div>
                  </div>
                </div>
