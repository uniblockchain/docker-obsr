            ...
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
                ...
                <div style="padding: 5px;">
                  ...
                  <div class="step On">  <script language="JavaScript">document.write(OBMName_Short);</script> (Client software) download / install</div>
                  <div class="notes">Please choose your language to download :
                    <form name="form" style="padding-top: 3px;">
                      ...
                      <input name="BUTTON" style="height: 19px; font-size: 11px;" onClick="javascript:openWindow('/obs/jsp/user/wizard/install/index.jsp?locale=' + form.menu.value)" value="Go" type="button">
                    </form>
                  </div>
                  <div style="padding-bottom: 5px;"><img src="../images/spacer.gif" height="1"></div>
                  <div class="step"><a href="nav_sm3.jsp" class="stepLink">  <script language="JavaScript">document.write(OBSName_Short);</script> User Console</a></div>
                </div>
              </td>
            </tr>
          </tbody>
