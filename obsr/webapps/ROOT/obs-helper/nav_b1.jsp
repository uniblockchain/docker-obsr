              ...
              <td rowspan="2" class="lNavigation" bordercolor="#F9F9F9" valign="top" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step On" bgcolor="#f9f9f9" width="99%"> Download <script language="JavaScript">document.write(ACBName_Short);</script></td>
                    </tr>
                  </tbody>
                </table>
				...
				<div class="notes">
                  <ol style="list-style-type: lower-roman;">
                    <li>Before getting started, please follow the instructions available in the <a href="javascript:openWindow('/obs/jsp/user/wizard/install/index.jsp?locale=en')"><script language="JavaScript">document.write(ACBName_Short);</script> installation wizard</a> to download and install <script language="JavaScript">document.write(ACBName_Short);</script>.<br>
                    </li>
                  </ol>
                </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step" bgcolor="#f9f9f9" width="99%"><a href="nav_b2.jsp" class="stepLink">Create an <script language="JavaScript">document.write(ACBName_Short);</script> account</a></td>
                    </tr>
                  </tbody>
                </table>
              </td>
