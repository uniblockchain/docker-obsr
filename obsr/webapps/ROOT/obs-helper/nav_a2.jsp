       ...
       <table cellpadding="0" cellspacing="0" height="10" width="100%">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tbody>
            <tr>
              <td rowspan="2" class="lNavigation" width="100%">
              <div class="Title"><img src="../images/ico_OBM.gif" align="absmiddle"> Getting Started with <script language="JavaScript">document.write(OBMName_Short);</script></div>
		      </td>
            </tr>
          </tbody>
        </table>
            ...
            <tr>
              <td rowspan="2" class="lNavigation" bordercolor="#F9F9F9" valign="top" width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step" bgcolor="#f9f9f9" width="99%"> <a href="nav_a1.jsp" class="stepLink">Download <script language="JavaScript">document.write(OBMName_Short);</script></a></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="step On" bgcolor="#f9f9f9" width="99%">Create an <script language="JavaScript">document.write(OBMName_Short);</script> account</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <ol style="list-style-type: lower-roman;">
                  ...
                  <li style="padding-bottom: 5px;">To add an <script language="JavaScript">document.write(OBMName_Short);</script> backup account on <script language="JavaScript">document.write(OBSName_Short);</script>, please go to [Manage User] -&gt; [Add User].</li>
                </ol>
                </div>
